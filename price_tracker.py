"""
iHerb Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from iHerb.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/iherb
"""
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of iHerb product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover iHerb products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a iHerb category page.

    Example:
        results = discover_by_category("https://iherb.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.iherb.com/product/sample-item-123456",
        # Add more iHerb product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "iherb_prices.json"
    ...
    # cat_results = discover_by_category("https://iherb.com/category/sample", limit=50)
